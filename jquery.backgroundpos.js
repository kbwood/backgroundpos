...
(function ($) { // Hide scope, no $ conflict
	...
	function initBackgroundPosition(tween) {
		// modern browsers
		var cssBackgroundPosition = $(tween.elem).css('backgroundPosition');

		// IE8 and below
		if (typeof cssBackgroundPosition === 'undefined') {
			cssBackgroundPosition = $(tween.elem).css('backgroundPositionX') + ' ' + $(tween.elem).css('backgroundPositionY')
		}

		tween.start = parseBackgroundPosition(cssBackgroundPosition);
